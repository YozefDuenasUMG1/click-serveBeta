    ...
    <div class="row-custom top">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <a href="/click/modulos/cliente/index.php" class="btn btn-success mt-3">Ver Menú Cliente</a>
        </div>
      </div>
    ...
    <div class="row-custom bottom">
      <div class="card">
        <div class="card-body">
          ...
          <a href="/click/modulos/cocinero/cocinero_panel.html" class="btn btn-warning mt-3">Ver Cocina</a>
        </div>
      </div>
